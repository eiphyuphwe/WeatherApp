...
object Validator {
    ...
    fun validateSignUpFields(username:String?,email: String?, password: String?): List<Validation> =
        ArrayList<Validation>().apply {

            when{

                username.isNullOrBlank() ->
                    add(Validation(Validation.Field.USERNAME, Resource.error(R.string.username_field_empty)))
                else -> add(Validation(Validation.Field.USERNAME, Resource.success()))
            }
