package com.aster.app.weather.ui.base
...
import com.aster.app.weather.di.component.DaggerViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as WeatherApplication).applicationComponent)
